...
if not using_snow: # snow is all zero
    formula_full = "trip_count ~ temperature_c + rain_mm + weekend_flag + C(region) + C(month) + C(hour)"
    formula_reduced = (
    ...
    formula_full = "trip_count ~ temperature_c + rain_mm + snow_mm + weekend_flag + C(region) + C(month) + C(hour)"
    formula_reduced = (
    "trip_count ~ rain_mm + snow_mm + weekend_flag "
    "+ C(region) + C(month) + C(hour)"
    )
