...
STATIONS_DATAPATH = "data/raw/LA/metro-bike-share-stations.csv"
WEATHER_DATAPATH = "data/processed/weather_data"
REGIONS = ["Westside", "DTLA", "North Hollywood"]

HOURLY_OUTPUT_PATH = f"data/processed/panels/LA_hourly_{tag}.csv"
...
plt.savefig("plots/assembly/LA_hourly_trips_by_region.png")
...
plt.savefig("plots/assembly/LA_temp_vs_trips_scatter.png")
