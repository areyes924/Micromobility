...
# Import Data
station_map = pd.read_csv("metro-bike-share-stations-2025-10-01.csv")
q3_2025 = pd.read_csv("metro-trips-2025-q3.csv")
q2_2025 = pd.read_csv("metro-trips-2025-q2.csv")

# When testing, it's nice to just focus on one.
df = q2_2025
...
# Filter for rides that start at drake_id and end at perloff_id
